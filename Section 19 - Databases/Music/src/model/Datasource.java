...
public class Datasource {
    ...
    ;
    //public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\asoto\\Documents\\Databases\\" + DB_NAME;
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\asoto\\Documents\\Projects\\JavaProgrammingMasterclass\\Section 19 - Databases\\Music\\" + DB_NAME;
    ...
    // INNER JOIN artist ON albums.artist = artists._id
    ...
    public static final String QUERY_VIEW_SONG_INF = "SELECT " + COLUMN_ARTIST_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = \"";

    // SELECT name, album, track FROM artist_list WHERE title = ? ORDER BY ?, ?
    // placeholder 1 for the title, 2 for the order by, 3 for the order by
    ...
    public static final String QUERY_SONG = "SELECT " + COLUMN_ALBUM_ID + " FROM " +
    ...
    public boolean open() {
        try {
            ...
            // We will be able to get the generated id
    ...
    public List<Song> querySongs() {
        System.out.println("SELECT * FROM " + TABLE_SONGS);
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                ...
                song.setName(results.getString(COLUMN_SONG_TITLE));
                song.setAlbumId(results.getInt(COLUMN_SONG_ALBUM));
                songs.add(song);
            }
    ...
    public List<SongArtist> queryArtistForSong(String songName, int sortOrder) {
        ...
        if (sortOrder != ORDER_BY_NONE) {
            sb.append(QUERY_ARTIST_OR_SONG_SORT);
            if (sortOrder == ORDER_BY_DESC) {
                sb.append("DESC");
            } else {
                sb.append("ASC");
