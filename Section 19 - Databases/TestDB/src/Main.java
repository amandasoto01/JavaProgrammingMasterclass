...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            insertContact(statement, "Tim", 6545578, "tim@email.com");
        ...
        /* Try with resources to automatically close the database
        try (Connection conn = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\asoto\\Documents\\Databases\\testjava.db");
             Statement statement = conn.createStatement();
        ) {
